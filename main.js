...
module.exports = "<div class=\"card card-body\">\n  <form (ngSubmit)=\"onSubmit()\">\n    <div class=\"form-group\">\n      <input type=\"text\" name=\"text\" [(ngModel)]=\"text\" class=\"form-control mb-1\" placeholder=\"Add a log...\">\n      <input type=\"submit\" value=\"Add Log\" class=\"btn btn-primary \" [disabled]=\"!this.text\">\n      <button (click)=\"clearState()\" type=\"button\" class=\"btn btn-outline-warning ml-1\" [hidden]=\"!this.text\">Clear</button>\n    </div>\n  </form>\n</div>\n"
...
var LogFormComponent = /** @class */ (function () {
    ...
    LogFormComponent.prototype.ngOnInit = function () {
        var _this = this;
        //Subscribe to the selectedLog obsevrable
        this.logService.selectedLogs.subscribe(function (log) {
            // console.log(log);
            if (log.id !== null) {
                _this.isNew = false;
                _this.id = log.id;
...
module.exports = ".log-date {\r\ncolor: #777;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<ul class=\"list-group mt-3\" *ngIf=\"loaded && logs.length > 0\">\n  <li *ngFor=\"let log of logs\" [class.list-group-item-secondary]=\"selectedLog === log\" class=\"list-group-item d-flex justify-content-between align-items-center mb-1\">\n    <a (click)=\"onSelect(log)\" href=\"#\"> {{ log.text }} </a>\n    <span class=\"log-date\"> {{ log.date |date: 'short' }} </span>\n    <i (click)=\"onDelete(log)\" class=\"fa fa-remove\"></i>\n  </li>\n  \n</ul>\n<div *ngIf=\"loaded && logs.length == 0\">\n  <h5>There are not logs in the system</h5>\n</div>\n<div *ngIf=\"!loaded\">\n  <h5>Loading...</h5>\n</div>\n"
...
module.exports = "a {\r\n  color: #fff;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<nav class=\"navbar navbar-info bg-info mb-3\">\n  <div class=\"container\">\n    <a href=\"/\" class=\"navbar-brand\">\n      Devlogger\n    </a>\n  </div>\n</nav>\n"
...
var LogService = /** @class */ (function () {
    function LogService() {
        ...
        this.selectedLogs = this.logSource.asObservable();
...
module.exports = __webpack_require__(/*! C:\Users\Silviu\Desktop\Angular 5, 6 and 7 with Brad Traversy\Devlogger\src\main.ts */"./src/main.ts");
